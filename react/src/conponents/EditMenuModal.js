...
function EditMenuModal({setMenus, menu, setMessage, setError}) {
  ...
  const handleSubmit = (e) => {
    ...
    axios
    .post(`/api/menus/update/${menu.id}`, file)
    .then((res) => {
  ...
  return (
    <div className="modal fade" id={`editMenuModal${menu.id}`} tabIndex="-1"> 
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
              <h5 className="modal-title">メニュー編集</h5>
          ...
          <div className="modal-body">
            <form onSubmit={handleSubmit}>
              ...
              <input id="menu_name" type="text" className="form-control" defaultValue={menu.menu_name} onChange={(e) => {setMenuName(e.target.value)}} />
              <label htmlFor="price" className="form-label">値段</label>
              <input id="price" type="text" className="form-control" defaultValue={menu.price} onChange={(e) => {setMenuPrice(e.target.value)}} />
